...
const FormDetailsFields = () => {
   return (
      <>
         ...
         <FormField name='email' label='Email' type='email' placeholder='jane.doe@example.com' required />
         <FormField name='address' label='Address' type='text' placeholder='185 Berry St. Suite 550' required />
         ...
         <FormField name='postal' label='Postal' type='number' placeholder='1000' required />
      </>
   );
};
